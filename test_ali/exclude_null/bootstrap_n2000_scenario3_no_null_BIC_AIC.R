...
# ============================================================
SCENARIOS      <- c("constant")     # scenario 3
...
TRUE_PAF       <- 0.378045 # exact manuscript value for weight_hypo="constant"
                            #   P0_true = 0.048771
                            #   true_P_observed = 0.078415
...
OUT_DIR        <- "output_n2000_scenario3_no_null_BIC_AIC"

cat("Starting n=2000 scenario-3 bootstrap study with non-null BIC/AIC selection...\n")
