...
# ============================================================
SCENARIOS      <- c("only_current") # scenario 4
...
TRUE_PAF       <- 0.551951 # exact manuscript value for weight_hypo="only_current"
                            #   P0_true = 0.048771
                            #   true_P_observed = 0.108851
...
OUT_DIR        <- "output_n2000_scenario4_no_null_BIC_AIC"

cat("Starting n=2000 scenario-4 bootstrap study with non-null BIC/AIC selection...\n")
