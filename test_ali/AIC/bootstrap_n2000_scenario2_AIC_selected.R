...
# ============================================================
SCENARIOS      <- c("middle_peak")   # scenario2: manuscript weight-function scenario "middle_peak"
...
TRUE_PAF       <- 0.402761 # exact value from the manuscript's own true-value machinery
                            # (5_function_to_get_summary_plot_and_table.R), for weight_hypo="middle_peak":
                            #   P0_true = 1 - exp(-100*lambda0) = 0.048771  (A=0 throughout, same for all scenarios)
                            #   true_P_observed = 0.08166  (hardcoded table, middle_peak/HR=4/lambda=0.0005)
...
OUT_DIR        <- "output_n2000_scenario2_AIC_selected"
