...
# ============================================================
SCENARIOS      <- c("decreasing")   # scenario 1 only for this first cluster run
...
TRUE_PAF       <- 0.449697 # exact value from (5_function_to_get_summary_plot_and_table.R):
                            #   P0_true = 1 - exp(-100*lambda0) = 0.048771  (A=0 throughout)
                            #   true_P_observed = 0.088625  (hardcoded table, decreasing/HR=4/lambda=0.0005)
                            #   true_PAF = (0.088625 - 0.048771) / 0.088625 = 0.449697
                            # Depends only on weight_hypo, lambda0, HRA -- NOT on n, so this value
                            # is unchanged from the manuscript's n=10000/50000 scenarios.
OUT_DIR        <- "output_n2000_scenario1_AIC_selected"
